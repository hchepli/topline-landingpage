  ...
  return (
    ...
    >
      <div className="w-full max-w-6xl flex flex-col items-center text-center gap-10 px-4 sm:px-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start w-full py-10 md:py-20 gap-12 lg:gap-6">
          ...
          <Reveal delay={0.2} direction="right" className="flex w-full lg:w-[45%] justify-center items-start gap-8 flex-col">
            ...
            <a
              className="bg-black text-white p-3 pl-6 flex justify-center items-center gap-5 rounded-full"
