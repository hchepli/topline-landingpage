  ...
  return (
    ...
    >
      <div className="w-full max-w-6xl flex flex-col items-center text-center gap-10">
        ...
        <div className="flex justify-between items-center w-full gap-20 py-20">
          <div className="flex w-[45%] justify-center items-start gap-10 flex-col">
            <h3 className="text-4xl text-start font-semibold">Vamos conversar sobre a gestão <span className="text-[rgb(var(--brand-secondary))]">da sua empresa</span></h3>
            <p className="text-start text-[rgb(var(--text-secondary)/0.5)] w-[83%]">Entenda como a TopLine pode ajudar você a ter mais clareza, organização e segurança nas decisões do dia a dia.</p>
         ...
         <div className="w-[42%] rounded-2xl p-10 flex flex-col gap-6 shadow-md">
